...
export const paths = {
  ...
  provinceMunicipalityTypes: path.join(rootDir, 'source', 'reference', 'province-municipality-types.json'),
  ...
  sourceLabels: path.join(rootDir, 'source', 'reference', 'source-labels.json'),
  displayNameOverrides: path.join(rootDir, 'source', 'reference', 'display-name-overrides.json'),
  mahalleOpenDataSources: path.join(rootDir, 'source', 'reference', 'mahalle-open-data-sources.json'),
  mahalleOpenDataNameOverrides: path.join(rootDir, 'source', 'reference', 'mahalle-open-data-name-overrides.json'),
  qualityOverrides: path.join(rootDir, 'source', 'reference', 'quality-overrides.json'),
  mulkiIdareDir: path.join(rootDir, 'source', 'mulki-idare'),
  settlementsDir: path.join(rootDir, 'source', 'mulki-idare', 'yerlesimler'),
  manualMahalleRawDir: path.join(rootDir, 'source', 'mahalle-manual'),
