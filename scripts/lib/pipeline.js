...
export const paths = {
  ...
  legacyMahalleSources: path.join(rootDir, 'source', 'reference', 'legacy-mahalle-sources.json'),
  legacyMahalleNameOverrides: path.join(rootDir, 'source', 'reference', 'legacy-mahalle-name-overrides.json'),
  ...
  legacyMahalleRawDir: path.join(rootDir, 'source', 'legacy-mahalle'),
